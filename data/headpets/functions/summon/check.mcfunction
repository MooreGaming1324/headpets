...
execute if entity @p[tag=hpetActive] run function headpets:summon/fail
...
execute if data entity @s Item.tag.hpet.OwnerID run execute unless score @p hpet.player_id = .Id hpet.temp run function headpets:summon/fail
